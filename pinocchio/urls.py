...
urlpatterns = [
		  ...
		  url(r'^questionnaire/(?P<questionnairePk>[0-9]+)/?$', views.questionnaire, name='questionnaire'),
                  ...
                  url(r'^questionAdmin/getQuestion/$', views.getQuestion),
                  url(r'^questionAdmin/getQuestionList/$', views.getQuestionList),
                  url(r'^questionAdmin/getChoices/$', views.getChoices),
                  url(r'^questionAdmin/getRank/$', views.getRank),
                  url(r'^questionAdmin/getRates/$', views.getRates),
                  url(r'^questionAdmin/getFreeformItems/$', views.getFreeformItems),
